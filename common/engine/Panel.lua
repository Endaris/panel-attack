...
class(
  function(p, id, row, column, frameTimes)
    ...
    metatable.__tostring = function(panel)
      return "row:"..panel.row..",col:"..panel.column..",color:"..panel.color..",state:"..panel.state..",timer:"..panel.timer.."currentAnim:"..panel.currentAnim..",currentTime:"..panel.currentTime..",frame:"..panel.frame..",loop:"..panel.loop..",finished:"..panel.finished..",animation:"..panel.animation..",switchFunction:"..panel.switchFunction()
    end
